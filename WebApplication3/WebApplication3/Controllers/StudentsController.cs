...
namespace WebApplication3.Controllers
{
    public class StudentsController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "StudentID,PersonID,CGPA")] Student student)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "StudentID,PersonID,CGPA")] Student student)
        {
            if (ModelState.IsValid)
            {
